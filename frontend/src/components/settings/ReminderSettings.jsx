    ...
    <div className="space-y-6">
      ...
      >
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            <div className={`p-2 rounded-lg ${enabled ? 'bg-green-500/20' : 'bg-gray-700/50'}`}>
              {enabled ? (
      ...
      >
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-lg font-semibold text-white">Intervalles de relance</h3>
        </div>
      ...
      >
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-lg font-semibold text-white">Sujets des emails</h3>
        </div>
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
              <p className="text-sm text-gray-400">Niveau 2</p>
              <p className="text-2xl font-bold text-amber-400">{stats.level_2_count || 0}</p>
            </div>
            <div className="bg-rose-500/10 border border-rose-500/30 rounded-lg p-4">
              <p className="text-sm text-gray-400">Niveau 3</p>
