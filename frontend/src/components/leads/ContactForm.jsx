...
const ContactForm = ({ contact = {}, onSave, onCancel }) => {
  ...
  return (
    <div className="bg-surface-muted/40 rounded-lg p-5">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {/* Poste / Fonction */}
          <div>
            <label htmlFor="contact-position" className="block text-sm font-medium text-text-secondary mb-1">
              Fonction
            </label>
            <input
              type="text"
        ...
        {/* Notes */}
        <div>
          <label htmlFor="contact-notes" className="block text-sm font-medium text-text-secondary mb-1">
            Notes
          </label>
          <textarea
            id="contact-notes"
        ...
        <div className="flex items-center">
          ...
          />
          <label htmlFor="contact-is-primary" className="ml-2 text-sm text-text-secondary">
            Contact principal
          </label>
        </div>
        ...
        <div className="flex justify-end space-x-3 pt-2">
          ...
          <motion.button
            type="submit"
            className="px-4 py-2 rounded-lg bg-accent hover:bg-indigo-700 text-white font-medium flex items-center"
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
            disabled={submitting}
          >
