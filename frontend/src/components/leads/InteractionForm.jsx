    ...
    <div className="bg-gray-900/40 rounded-lg p-4 sm:p-5">
      ...
      <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
          {/* Date et heure */}
          <div>
            <label htmlFor="interaction-date" className="block text-xs sm:text-sm font-medium text-gray-300 mb-1">
          ...
          {/* Contact associé */}
          <div>
            <label htmlFor="interaction-contact" className="block text-xs sm:text-sm font-medium text-gray-300 mb-1">
              Contact associé
            </label>
            <select
        ...
        {/* Description */}
        <div>
          <label htmlFor="interaction-description" className="block text-xs sm:text-sm font-medium text-gray-300 mb-1">
