...
import { FiMonitor, FiEdit2, FiUsers, FiPhone, FiRadio, FiTool, FiClipboard, FiCheckCircle, FiZap, FiUser, FiClock } from 'react-icons/fi';
...
const ActivityList = ({ activities, selectedActivity, onSelectActivity, onCompleteActivity }) => {
  ...
  const typeConfig = {
    ...
    'marketing': { icon: <FiRadio />, label: 'Marketing', bg: 'bg-amber-900/20' },
