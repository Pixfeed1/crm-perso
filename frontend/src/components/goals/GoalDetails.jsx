...
import { FiUsers, FiDollarSign, FiSettings, FiVolume2, FiStar, FiCheckCircle, FiClock, FiZap, FiAlertCircle, FiMinusCircle, FiMapPin, FiEdit2, FiTrash2, FiTrendingUp, FiClipboard, FiAward, FiCheck, FiCircle } from 'react-icons/fi';
...
const GoalDetails = ({
  ...
  const categoryConfig = {
    ...
    'marketing': { icon: <FiVolume2 />, label: 'Marketing', color: 'text-amber-300' },
