...
// Type segmente (Appel / SMS / Note), date, notes, resultat (chips), prochaine relance.
import React, { useState, useEffect } from 'react';
import { motion, AnimatePresence } from 'framer-motion';
import { FiPhone, FiMessageSquare, FiFileText, FiX, FiPlus } from 'react-icons/fi';
...
const LogExchangeModal = ({ isOpen, onClose, onSaved, contactType, contactId, phone, defaultType = 'appel', contactName }) => {
