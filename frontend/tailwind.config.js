  ...
  theme: {
    extend: {
      colors: {
        ...
        'success-bg': withVar('--success-bg'),
        'success-text': withVar('--success-text'),
        'danger-bg': withVar('--danger-bg'),
        'danger-text': withVar('--danger-text'),
        'warning-bg': withVar('--warning-bg'),
        'warning-text': withVar('--warning-text'),
        'info-bg': withVar('--info-bg'),
        'info-text': withVar('--info-text'),
        'neutral-bg': withVar('--neutral-bg'),
        'neutral-text': withVar('--neutral-text'),
      },
    },
  },
  plugins: [],
